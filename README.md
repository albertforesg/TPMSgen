...
A [**standalone release v1.0.0**](https://github.com/albertforesg/TPMSgen/releases/tag/v1.0.0) has already been published and it is the simpliest way to execute the [**TPMSgen**](https://github.com/albertforesg/TPMSgen) application. 
...
If the compiled files of the release do not work properly on your system of choice, you can solve it by running the GUI version or execute the CLI version of [**TPMSgen**](https://github.com/albertforesg/TPMSgen) directly from your Python interpreter.
